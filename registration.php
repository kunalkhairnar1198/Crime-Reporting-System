     ...
     function f1()
        {
			...
			var sta5=document.getElementById("imagep");
  var x=sta.trim();
  var x1=sta1.indexOf(' ');
  var x2=sta2.indexOf(' ');
  var x3=sta3.trim();
		 ...
		 <div class="bg-agile">
			...
			<div class="login-form">	
				...
				<form action="#" method="post">
                    ...
                    <p style="color:#dfdfdf">Password</p><input type="password"  name="password"  placeholder="6 Character minimum" pattern=".{6,}" id="password" onfocusout="f1()"/>
